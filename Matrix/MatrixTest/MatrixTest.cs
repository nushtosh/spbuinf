...
namespace Tests
{
    ...
    public class MatrixTest
    {
        ...
        [Test]
        public void BoolMatrix()
        {
            var rw = new ReaderWriter<bool>();
            var m1 = rw.ReadFile($"{_testDir}\\matrix_bool1.txt");
            var m2 = rw.ReadFile($"{_testDir}\\matrix_bool2.txt");

            var mm1 = new Matrix<bool>(m1);
            var mm2 = new Matrix<bool>(m2);
            ...
            var resFileContent = File.ReadAllLines(resFileDir);
            Assert.AreEqual("True;True", resFileContent[0]);
            Assert.AreEqual("True;True", resFileContent[1]);
